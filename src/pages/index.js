...
export default function Home() {
  ...
  return (
    <div className="">
      <div className=" h-8  bg-blue-600 w-full">
        <Link
          href="/login"
          className=" text-white p-2 flex h-full   items-center  justify-end mr-12"
        >
          <span className=" mr-4 font-serif">Нэвтрэх</span>
        ...
        <dh-component>
          ...
          <div className="bg-gray-100">
            <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
              <Image width={1920} height={1080} src={bgCover} />

              <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-gray-800 font-black leading-7 md:leading-10">
                  Электрон номын санд тавтай морил
      ...
      <h1 className="mt-12 text-2xl text-gray-500 ml-12">Бүх номнууд</h1>
      <div className="flex mx-12 p-12">
        {data?.map((product, i) => (
